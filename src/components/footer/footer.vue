<template>
  <section dir="rtl" class="row top-footer">
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 contact-us">
      ...
      <a
        v-if="baseData && baseData.insuranceCentre"
        :href="'tel:' + baseData.insuranceCentre.phone"
        class="row call-number justify-start items-center q-mt-sm cursor-pointer"
      >
      ...
      <a
        v-if="baseData && baseData.insuranceCentre"
        :href="'mailto:' + baseData.insuranceCentre.email"
        class="row email justify-start items-center q-mt-sm cursor-pointer"
      >
      ...
      <div class="row justify-start items-center q-mt-sm">
        <div>
          <p
            v-if="baseData && baseData.insuranceCentre"
            class="top-footer-location-text"
          >
            <q-icon class="q-ml-xs" name="place" width="24px"></q-icon>
  ...
  <section
    class="row justify-center items-center text-center shadow-1 middle-footer"
  >
    <div
      class="dynamic-certificate-item"
      v-if="
        baseData.insuranceCentrePortal &&
        baseData.insuranceCentrePortal.eTrustSymbol
      "
    >
      <div
        id="eNamad"
    ...
    <div
      v-if="
        baseData &&
        baseData.insuranceCentre &&
        baseData.insuranceCentre.metaMediaActivityLicenceUrl
      "
      class="sign-img-container cursor-pointer"
    >
      <q-img
        @click="
          openNewPage(baseData.insuranceCentre.metaMediaActivityLicenceUrl)
        "
        class="kargozar-sign"
    ...
    <div
      ...
      v-if="
        baseData.insuranceCentrePortal &&
        baseData.insuranceCentrePortal.digitalMediaOrganizerSymbol
      "
    >
      <div
        id="samandehi"
  ...
  <footer
    v-if="baseData && baseData.footerContent"
    class="bottom-footer text-center"
  >
...
export default {
  ...
  methods: {
    ...
    setCertificatesStaticImage() {
      ...
      eNamadImg.src =
        "https://media.easybimeh.com//Easybimeh/FileManager/EasyBimeh/enamad.png";
      var samandehiImg = document.querySelector("#samandehi img");
      samandehiImg.src =
        "https://media.easybimeh.com//Easybimeh/FileManager/EasyBimeh/samandehi.png";
    },
  },
};
</script>
