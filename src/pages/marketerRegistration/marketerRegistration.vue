    ...
    <div class="marketer-containser flex" style="border-radius: 10px;overflow: hidden;">
        <div class="sidebar">
            <div class="contract-header flex column justify-center items-center">
              ...
              <img src="images/marketerRegistration.jpg" style="border-radius:50%;" alt="ثبت نام">
            </div>
        </div>
        ...
        <div class="form-container">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-item">
                <q-input
                  ...
                  color="teal" outlined type="number" v-model="model.nationalCode"   label="کد ملی*">
                </q-input>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-item">
                <q-input
                 class="label-right numeric-input"
                  ...
                  color="teal"  outlined v-model="model.email"   label="ایمیل*">
                </q-input>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-item">
                <q-input
                  ...
                  color="teal" class="label-right numeric-input" outlined type="number" v-model="model.mobile"   label="تلفن همراه*">
                </q-input>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-item">
                <q-input
                  ...
                  color="teal" class="label-right numeric-input" outlined type="number" v-model="model.phone"   label="تلفن ثابت با پیش شماره*">
                </q-input>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-item">
                 <q-select
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-item">
                 <q-select
                   class="label-right"
                    ...
                    color="teal" outlined label="استان*" v-model="provinceModel" :options="proviance">
                    <template v-slot:append>
                        <q-icon name="arrow_drop_down" />
                    </template>
                 </q-select>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-item">
                 <q-select
                   class="label-right"
                    ...
                    color="teal" outlined label="شهر*" v-model="cityModel" :options="city">
                    <template v-slot:append>
                       <q-icon name="arrow_drop_down" />
                    </template>
                </q-select>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-item">
                <q-input
                  ...
                  color="teal"  type="number" outlined v-model="model.zipCode"   label="کد پستی*">
                </q-input>
            </div>
            <div class="row col-lg-6 col-md-12 col-sm-12 col-xs-12 form-item">
                <div class="col-12">
                  ...
                  color="teal"   class="numeric-input label-right iban" type="number" outlined v-model="model.IBAN"  label="شماره شبا*">
                 </q-input>
                </div>
            </div>
            <div class="row col-lg-6 col-md-12 col-sm-12 col-xs-12 form-item">
                <div class="col-12">
                  ...
                  color="teal"   class="numeric-input iban label-right" type="number" outlined v-model="model.cardNumber"  label="شماره کارت*">
                 </q-input>
                </div>
            </div>
           <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-item">
                <q-input
                 @keypress="controlLength($event, 18)"
                  color="teal" class="numeric-input label-right" type="number" outlined v-model="model.identityNumber"   label="شماره حساب">
                </q-input>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-item">
                <q-input
...
<script>
  ...
  export default defineComponent({
    ...
    data(){
        return{
          ...
          model:{
             firstName:"",lastName:"",email:"",nationalCode:"",
             mobile:"",phone:"",genderType:"",birthDay:"",educationId:"",
             workExperienceId:"",cityId:"",postalAddress:"",zipCode:"",
             IBAN:"",identityNumber:"",bimehExperienceId:"",cardNumber:"",
             representativeCode:"",acceptContract:false,contractContent:"",contentFile:"",descriptionExperience:""
          },
    ...
    methods:{
      async init(){
       ...
       this.lastEducationalCertificate= (await optionServices.getLastEducationalCertificate()).data.message;
       this.workExperience= (await optionServices.getWorkExperience()).data.message;
       this.genderTypesList= (await optionServices.getGenderTypes()).data.message;
       var contractContentResponse=await services.getContractContent();
       this.contractContent=contractContentResponse.data.message.contractContent;
       if(contractContentResponse.data.message.contentFile){
         this.contentFile=contractContentResponse.data.message.contentFile;
       }
       if(this.contractContent.replace(/firstName/g, "<span class='replaced-span first-name'></span>")){
         this.contractContent=this.contractContent.replace(/firstName/g, "<span class='replaced-span first-name' ></span>")
       }
       if(this.contractContent.replace(/lastName/g, "<span class='replaced-span last-name' ></span>")){
         this.contractContent=this.contractContent.replace(/lastName/g, "<span class='replaced-span last-name' ></span>")
       }
       if(this.contractContent.replace(/nationalCode/g, "<span class='replaced-span national-code' ></span>")){
         this.contractContent=this.contractContent.replace(/nationalCode/g, "<span class='replaced-span national-code' ></span>")
       }
       if(this.contractContent.replace(/city/g, "<span class='replaced-span city' ></span>")){
         this.contractContent=this.contractContent.replace(/city/g, "<span class='replaced-span city' ></span>")
       }
       if(this.contractContent.replace(/province/g, "<span class='replaced-span province' ></span>")){
         this.contractContent=this.contractContent.replace(/province/g, "<span class='replaced-span province' ></span>")
       }
       if(this.contractContent.replace(/address/g, "<span class='replaced-span address' ></span>")){
         this.contractContent=this.contractContent.replace(/address/g, "<span class='replaced-span address' ></span>")
       }
       if(this.contractContent.replace(/zipCode/g, "<span class='replaced-span zip-code' ></span>")){
         this.contractContent=this.contractContent.replace(/zipCode/g, "<span class='replaced-span zip-code' ></span>")
       }
       if(this.contractContent.replace(/phone/g, "<span class='replaced-span phone' id='phone'></span>")){
         this.contractContent=this.contractContent.replace(/phone/g, "<span class='replaced-span phone' ></span>")
       }
   ...
   async provinceChanged(){
      this.model.cityId="";
      this.city=(await optionServices.getCityByProvinceId(this.provinceModel.id)).data.message;
    },
    ...
    changeDate(data)
  {
    ...
    var shamsi = require('shamsi-date-converter');
     var convertedDate=shamsi.jalaliToGregorian(parseInt(data.split('/')[0]), parseInt(data.split('/')[1]), parseInt(data.split('/')[2]))
  ...
  async sendCode()
  {
    ...
    async register(){
       ...
       var convertedDate=shamsi.jalaliToGregorian(parseInt(this.selectedDate.split('/')[0]), parseInt(this.selectedDate.split('/')[1]), parseInt(this.selectedDate.split('/')[2]))
       this.gregorianBirthDay=convertedDate[0]+'-'+convertedDate[1]+'-'+convertedDate[2];
