<template>
    <q-card-section class="tracking-insurance-container" style="max-width: 70rem; margin: auto; direction: rtl;">
      <q-card-section>
      ...
      <q-form @submit="submit()">
        <div class="row" style="max-width: 70rem; margin: auto;">
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 q-pa-sm">
            <q-input outlined class="label-right" label="کد رهگیری یا شماره سریال بیمه نامه*"  v-model="trackingCode"
