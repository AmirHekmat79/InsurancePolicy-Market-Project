<template>
  <div class="images-gallery-section row text-center" v-if="imageAlbums && imageAlbums.length" >
    ...
    <div v-if="imageAlbums.length > 4" class="col-12 show-more-button-container flex justify-center items-center">
            ...
            <q-card  class="gallery-details-dialog" v-if="showGalleryDetailsDialog">
               ...
               <q-card-section >
                    <div class="flex justify-center items-center">
                      <q-img class="gallery-details-image" width="200px" v-for="(item , index) in galleryDetails" :key="index" :src="item.metaMediaFileUrl" />
                    </div>
               </q-card-section>
            </q-card>
      </q-dialog>
