          ...
          <q-img
            ...
            :src="
              this.activeBtn === 'footerSection'
                ? 'icons/contact (1) (1).svg'
                : 'icons/contact.svg'
            "
          ></q-img>
          <p class="text-white text-subtitle1 text-weight-bolder">
